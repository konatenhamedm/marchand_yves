...
import { Store, User, Phone, Mail, Coins, Globe, MapPin } from "lucide-react";
                ...
                <div className="p-6 space-y-4 bg-white">
                    <div className="grid grid-cols-1 gap-4">
                        ...
                        <div className="flex items-start gap-4 p-3 rounded-xl bg-slate-50 border border-slate-100 group">
                            ...
                            <div>
                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Propriétaire</p>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="flex items-start gap-4 p-3 rounded-xl bg-slate-50 border border-slate-100 group">
                                ...
                                <div>
                                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Tél</p>
                            ...
                            <div className="flex items-start gap-4 p-3 rounded-xl bg-slate-50 border border-slate-100 group">
                                ...
                                <div>
                                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Devise</p>
                                    <p className="text-sm font-bold text-slate-700">{data.pays_devise?.devise?.code}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4 p-3 rounded-xl bg-slate-50 border border-slate-100 group">
                            ...
                            <div>
                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Adresse / Localisation</p>
                                <p className="text-sm font-medium text-slate-700">{data.adresse || 'N/A'}</p>
                            </div>
                        </div>
                    </div>
                </div>
