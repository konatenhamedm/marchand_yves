...
import { Plus, Tag, Store, Trash } from "lucide-react";
...
export default function CategoriesPage() {
    const { canCreate, canEdit, canDelete } = usePermissions("gestionCategories");
    ...
    const refreshData = () => {
        if (!magasinId) return;
        setIsLoading(true);
        apiFetch(`/categorie_produit_services/all/magasin/${magasinId}?per_page=${itemsPerPage}&page=${currentPage}`)
