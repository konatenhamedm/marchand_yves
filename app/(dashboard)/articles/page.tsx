    ...
    return (
        <ClientOnly>
            <div className="space-y-5">
                ...
                <PageHeader
                    title="Articles"
                    description="Articles achetés auprès des fournisseurs"
                    ...
                    <table className="w-full">
                        ...
                        <tbody>
                            {isLoading ? (
                                ...
                                <EmptyState message="Aucun article trouvé" icon={<Package className="w-10 h-10" />} cols={COLS} />
                            ) : (
