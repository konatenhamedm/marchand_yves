    ...
    return (
        <ClientOnly>
            <div className="space-y-5">
                ...
                <PageHeader
                    title="Fournisseurs"
                    description="Gestion des fournisseurs du magasin"
                    ...
                    <table className="w-full">
                        ...
                        <tbody>
                            {isLoading ? (
                                ...
                                <EmptyState message="Aucun fournisseur trouvé" icon={<Truck className="w-10 h-10" />} cols={COLS} />
                            ) : (
